                                ...
                                const GValue *value, GParamSpec *pspec)
{
    ...
    default:
        ...
        if(!retval)
            retval = ipatch_dls2_info_set_property(&sample->info,
                                                   property_id, value);
                                ...
                                GValue *value, GParamSpec *pspec)
{
    ...
    default:
        ...
        if(!retval)
            retval = ipatch_dls2_info_get_property(sample->info,
                                                   property_id, value);
