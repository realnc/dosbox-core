                          ...
                          gpointer user_data)
{
    ...
    if(refsample)
    {
        ipatch_sli_zone_set_sample(dest_zone, refsample);
    }
                                ...
                                gboolean sample_notify)
{
    ...
    if(sample)
    {
        g_object_ref(sample);    /* ref for zone */
    }
